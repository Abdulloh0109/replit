          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-serif font-bold text-slate-900 mb-6 leading-tight">
                Bank Tizimining <br />
                <span className="text-primary">Barqaror O'sish Sur'atlari</span>
              </h2>
              <p className="text-slate-600 mb-8 leading-relaxed text-lg">
                2024-2026 yillarda O'zbekiston bank tizimi aktivlari va
                kapitalining sezilarli o'sishi kuzatildi. Xususiylashtirish
                jarayonlari va raqamli transformatsiya bozor dinamikasiga ijobiy
                ta'sir ko'rsatmoqda.
              </p>
            ...
            >
              <h4 className="font-bold text-slate-800 mb-6">
                Aktivlar O'sish Dinamikasi (mlrd so'm)
              </h4>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-slate-900 mb-4">
              Hududiy Tahlil va Statistika
            </h2>
            <p className="text-slate-600 max-w-2xl mx-auto">
              Viloyatlar kesimida bank xizmatlari qamrovi va xalqaro pul
              o'tkazmalari geografiyasi.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            >
              <div className="flex items-center space-x-3 mb-8 border-b border-slate-100 pb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-slate-900">
                    Hududiy Faollik Reytingi
                  </h3>
                  <p className="text-sm text-slate-500">
                    Viloyatlar bo'yicha bank xizmatlari hajmi
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-3 overflow-y-auto max-h-[200px] pr-2 custom-scrollbar">
                {regionalData.map((item, i) => (
                  <div
                    key={i}
                    className="flex items-center justify-between p-3 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors border border-transparent hover:border-slate-200 group"
                  >
